...
(function (root, factory) {
  ...
  sndcore = function () {
    ...
    */
    ...
    if (iOS) {
      ...
      var startIOS = function startIOS() {
  ...
  helpers = function () {
    ...
    p5.prototype._checkFileFormats = function (paths) {
      ...
      } else if ((typeof paths === 'undefined' ? 'undefined' : _typeof(paths)) === 'object') {
  ...
  soundfile = function () {
    ...
    p5.SoundFile.prototype.play = function (startTime, rate, amp, _cueStart, duration) {
      ...
      if (this.buffer) {
        ...
        var clearOnEnd = function clearOnEnd() {
          this._playing = false;
    ...
    p5.SoundFile.prototype.stopAll = function (_time) {
      ...
      if (this.buffer && this.bufferSourceNode) {
        for (var i = 0; i < this.bufferSourceNodes.length; i++) {
          if (_typeof(this.bufferSourceNodes[i]) !== undefined) {
            try {
  ...
  Tone_core_Tone = function () {
    ...
    var Tone = function Tone(inputs, outputs) {
