...
var laMonster= function(p5){
	...
	let resize=true;
	p5.preload = () => {
		monsterlooBackground = p5.loadImage("https://emclaren.github.io/hello-p5/dist/assets/img/MonsterLoo_Background2.png"); 
	}
	...
	p5.draw = () => {
		...
		p5.image(monsterlooBackground, -p5.width/3, 0, p5.height*6, p5.height); 
