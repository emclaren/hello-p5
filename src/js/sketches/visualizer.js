...
// p.thing="../dist/assets/img/sketch_imgs/planet.png"
    ...
    // }
      ...
      // q.preload = () => {
      //   console.log('preload');
      //   // q.song = q.loadSound("../dist/assets/img/sketch_imgs/planet.png");
...
let waveform = Array.from({length: 500}, () => Math.floor(Math.random() * 100));
       ...
       q.strokeWeight(1);
        ...
        q.sizeChange=q.random(50,150)
//         // Draw an ellipse with size based on volume
        q.ellipse(q.windowWidth / 2, q.windowHeight / 2, 200 + rms * (q.windowHeight / 2)-q.sizeChange, 200 + rms * (q.windowHeight / 2)-q.sizeChange)
